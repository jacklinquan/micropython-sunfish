...
This is an unofficial MicroPython port of Sunfish Chess Engine.
...
class Position(namedtuple("Position", "board score wc bc ep kp")):
    ...
    def rotate(self):
        ...
        return Position(
            swapcase("".join(reversed(self.board))),
            -self.score,
            self.bc,
            self.wc,
    ...
    def nullmove(self):
        ...
        return Position(
            swapcase("".join(reversed(self.board))), -self.score, self.bc, self.wc, 0, 0
        )
...
class Searcher:
    ...
    def search(self, pos, history=()):
        ...
        for depth in range(1, 10):  # 1000, (QL)
